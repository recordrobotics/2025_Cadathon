...
public final class Constants {
    ...
    public static final class Lights {
        ...
        public static final LEDPattern ALLIANCE_COLOR_FANCY_WITH_CLIMB = ALLIANCE_COLOR_FANCY.get();

        public static final LEDPattern elevatorPattern = LEDPattern.solid(Color.kWhite)
                .mask(LEDPattern.progressMaskLayer(() -> 0 / Constants.Elevator.MAX_HEIGHT));
        public static final Supplier<LEDPattern> coralIntakePattern = () -> LEDPattern.solid(Color.lerpRGB(
                Color.kRed,
                Color.kGreen,
                (0 - Constants.CoralIntake.ARM_UP) / (Constants.CoralIntake.ARM_DOWN - Constants.CoralIntake.ARM_UP)));
        public static final Supplier<LEDPattern> elevatorHeadPattern = () -> PULSATING_ORANGE;
